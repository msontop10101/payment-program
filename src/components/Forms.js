...
const PaymentForm = ({setSubmittedValues}) => (
                ...
                <Form>
                    <div className='flex justify-center'>
                        <div className='flex flex-col gap-y-2 w-[60%] p-4'>
                            <div className='mb-4'>
                                <h2 className="text-left text-base font-semibold leading-7 text-gray-900">Admin!</h2>
                                <p className="text-left mt-1 text-sm leading-6 text-gray-600">This is only accessible to the admin</p>
                            </div>
