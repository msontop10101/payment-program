...
const PaymentForm = ({ onSubmit }) => {
    return (
        <>
            <div className=' form mx-2 rounded bg-gradient'>
                <Formik
                            ...
                            <div className='flex justify-center'>
                                <div className='flex flex-col gap-y-2 w-[60%] p-4'>
                                    <div className='mb-4 text-center'>
                                        <h2 className="text-center head_text font-semibold leading-7 text-white-900">Administrador!</h2>
                                        <p className="text-center mt-1 text-md leading-6 text-gray-600">Esto solo es accesible para el administrador.</p>
                                    </div>
                                    <div className='center'>
                                        <div className='flex flex-col gap-y-1 text-left '>
                                            <label className='block text-left text-sm font-medium leading-6 text-gray-900'>Nombre</label>
                                        ...
                                        <div className='flex flex-col gap-y-1 my-2 text-left'>
